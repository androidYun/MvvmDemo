package com.xhs.addressbook.mitt;
...
public class MiitHelper {
    ...
    static final class UIUtilsHolder {
        final static MiitHelper MIIT_HELPER = new MiitHelper();
    }

    public static MiitHelper getInstance() {
        if (miitHelper == null) {
            miitHelper = UIUtilsHolder.MIIT_HELPER;
        }
        return miitHelper;
    }

    private static MiitCallBack miitCallBack;

    public void getDeviceIds(Context cxt, MiitCallBack miitCallBack) {
        this.miitCallBack = miitCallBack;
        try {
...
//        int nres=DirectCall(cxt);
        ...
        return MdidSdkHelper.InitSdk(cxt, false, new IIdentifierListener() {
            ...
            public void OnSupport(boolean isSupport, IdSupplier _supplier) {
                ...
                if (miitCallBack != null) {
                    miitCallBack.callBackSuccess(idstext);
                }
    ...
    public interface MiitCallBack {
        void callBackSuccess(String oaid);
    }
}
